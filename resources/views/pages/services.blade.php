    ...
    <div class="container">
        ...
        <div class="bento-grid">
            <div class="bento-card fade-scroll" style="border-top: 4px solid var(--primary);">
                ...
                <a href="https://katalog.inaproc.id/cv-solusi-arya-prima-02kc?page=1" target="_blank" class="btn btn-solid" style="width: 100%;">{{ __('Akses Portal') }}</a>
            </div>
            ...
            <div class="bento-card fade-scroll" style="border-top: 4px solid var(--primary);">
                ...
                <a href="https://www.mbizmarket.co.id/p/sappusat/catalog?page=1" target="_blank" class="btn btn-solid" style="width: 100%;">{{ __('Akses Hub') }}</a>
            </div>
