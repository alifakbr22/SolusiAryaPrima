        ...
        <div class="bento-grid">
            ...
            <div class="bento-card large fade-scroll" style="grid-column: span 2; padding: 48px;">
                ...
                <form action="{{ route('contact.store') }}" method="POST" style="display: flex; flex-direction: column; gap: 24px;">
                    ...
                    <input type="text" name="subject" placeholder="{{ __('Subjek Pesan') }}" style="padding: 20px; border-radius: 12px; border: 1px solid var(--slate-200); background: var(--white); color: var(--slate-800); outline: none;">
                    <textarea name="message" placeholder="{{ __('Isi Pesan Anda') }}" rows="6" required style="padding: 20px; border-radius: 12px; border: 1px solid var(--slate-200); background: var(--white); color: var(--slate-800); resize: none; outline: none;"></textarea>
                    <button type="submit" class="btn btn-solid" style="padding: 20px; font-weight: 700;">{{ __('Kirim Pesan') }}</button>
                </form>
            </div>
